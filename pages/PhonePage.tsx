...
import { Smartphone, FileCheck, HelpCircle } from 'lucide-react';
    ...
    <div className="pb-8">
      ...
      <section className="relative w-full bg-gradient-to-b from-slate-50 to-white py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            한국 체류·비즈니스에 필요한 휴대폰 개통을 성신컴퍼니가 안내해 드립니다.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed break-keep">
                단기 체류·장기 체류·사업자 등 목적에 맞는 요금제와 개통 방법을 안내해
                드립니다. 외국인 등록 여부에 따른 절차도 상담 시 설명해 드립니다.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed break-keep">
                필요한 신분증·서류, 통신사 선택, 개통 소요 시간 등 구체적인 내용은
